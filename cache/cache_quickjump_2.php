...
?>				<form id="qjump" method="get" action="viewforum.php">
					...
					<br /><select name="id" onchange="window.location=('viewforum.php?id='+this.options[this.selectedIndex].value)">
						...
						<optgroup label="Forum Mods, Devs and PkgMs">
							<option value="41"<?php echo ($forum_id == 41) ? ' selected="selected"' : '' ?>>General Discussion [PRIVATE]</option>
							<option value="28"<?php echo ($forum_id == 28) ? ' selected="selected"' : '' ?>>Moderator Discussion [PRIVATE]</option>
							<option value="37"<?php echo ($forum_id == 37) ? ' selected="selected"' : '' ?>>Unsure Topics [PRIVATE]</option>
							<option value="46"<?php echo ($forum_id == 46) ? ' selected="selected"' : '' ?>>Spam Purge [PRIVATE]</option>
					</optgroup>
					</select>
