...
'Bad HTTP Referer message'			=>	'Falscher HTTP_REFERER. Wenn Sie diese Foren innerhalb Ihrer Verzeichnisstruktur oder auf eine andere Domain verschoben haben, müssen Sie die Basis-URL in der Datenbank manuell aktualisieren (schauen Sie in der Tabelle config nach o_base_url) und leeren dann den Zwischenspeicher, indem Sie alle im Verzeichnis /cache enthaltenen .php-Dateien löschen.',
'Must enter title message'			=>	'Sie müssen ein Titel für dieses Board eingeben.',
...
'Base URL help'						=>	'Die vollständige URL des Forums ohne Folge-Slash (z.Bsp. http://www.meine-domain.de/foren). Damit alle Funktionen für Administratoren und Moderatoren ausgeführt werden können, <strong>MUSS</strong> dieser Eintrag richtig sein. Wenn Sie einen Fehler "Falscher Referer" bekommen, ist die Basis-URL höchstwahrscheinlich falsch.',
...
'Info in posts help'				=>	'Zeigt in der Themenansicht Informationen über den Autor des Beitrags unter dem Benutzernamen an. Die Einstellung hat Auswirkungen auf den Ort, das Registrierungsdatum, den Beitragszähler und die Kontakt-Links (E-Mail und Website).',
...
'Default feed help'					=>	'Wählen Sie den anzuzeigenden Feed-Typ. Hinweis: Die Auswahl "Ohne Vorgabe" daktiviert nicht die Feeds, sondern versteckt sie nur.',
'None'								=>	'Ohne Vorgabe',
'RSS'								=>	'RSS',
'Atom'								=>	'Atom',
...
'Both'								=>	'Beides',
'Reporting method help'				=>	'Wählen Sie hier eine Methode aus, wie Meldungen über Themen/Beiträge behandelt werden sollen. Sie haben mehrere Optionen zur Auswahl - entweder werden die Meldungen über ein internes Berichtssystem verarbeitet oder via E-Mail an eine Mailingliste (siehe unten) versandt werden. Es können auch beide Optionen parallel verwendet werden.',
...
'Subscriptions help'				=>	'Ermöglicht den Mitgliedern, Themen zu abonnieren (werden bei neuen Beiträgen zu diesem Thema via E-Mail informiert).',
...
'Verify help'						=>	'Wird dies aktiviert, wird den Neu-Mitgliedern nach der Registrierung ein zufällig erstelltes Password via E-Mail zugesandt. Erst dann können sich die neuen Mitglieder anmelden und das Passwort in ihrem Profil ändern. Auch, wenn die ursprüngliche Registrierungs-E-Mail-Adresse geändert wird, ist eine Bestätigung durch das Mitglied erforderlich. Dies ist ein effektiver Weg, um mißbräuchliche Registrierungen zu vermeiden und sicherzustellen, dass in den Profilen der Mitglieder die "richtigen" E-Mail-Adressen eingetragen sind.',
...
'Rules help'						=>	'Hier können Sie die Nutzungsbedingungen und sonstige Informationen eingeben, die sich jedes Neu-Mitglied durchlesen und akzeptieren muss. Um diese Option zu aktivieren, geben Sie in dieses Feld Ihre Nutzungsbedingungen ein - ohne Eintrag bleibt diese Option deaktiviert. Dieser Text wird nicht wie reguläre Beiträge verarbeitet und kann daher HTML enthalten.',
...
'Maintenance mode help'				=>	'Wird diese Option aktiviert, können nur die Administratoren auf das Board zugreifen. Dieser Modus sollte verwendet werden, wenn zeitlich beschränkte Wartungsarbeiten am Board erforderlich sind. WARNUNG! Melden Sie sich NIEMALS ab, wenn sich das Board im Wartungs-Modus befindet. Sie können sich anschließend niemals wieder anmelden.',
'Maintenance message label'			=>	'Wartungs-Nachricht',
'Maintenance message help'			=>	'Die Nachricht, die den Besuchern der Website angezeigt wird, wenn sich das Board im Wartungs-Modus befindet. Bleibt dieses Feld leer, wird eine voreingestellte Nachricht verwendet. Dieser Text wird nicht wie reguläre Beiträge verarbeitet und kann daher HTML enthalten.',
